...
Generate, retrieve and stash the JSON _key_ for the service account you use to run `devpod` on your machine; this can be done using [Google Cloud Console UI](http://console.cloud.google.com) - or with a `gcloud` CLI command:
```shell
