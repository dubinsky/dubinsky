...
I couldn't find One-Jar in any Maven repository, so it has to be loaded into your corporate repository, or to a in-project repository (see [[maven-in-project-repository]]).
